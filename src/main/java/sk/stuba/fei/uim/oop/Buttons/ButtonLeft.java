...
public class ButtonLeft extends Button {
    ...
    public ButtonLeft(String name, int buttonWidth, int buttonHeight , CreateMaze createMaze, Player player, PaintGamePanel paintGamePanel, SolvedMazeCounter solvedMazeCounter, int rowCols) {
        setName(name);
