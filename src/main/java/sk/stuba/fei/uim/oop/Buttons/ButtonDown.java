...
public class ButtonDown extends MoveButton {
    ...
    public ButtonDown(String name, int buttonWidth, int buttonHeight , int cellSize, CreateMaze maze, Player player, PaintGamePanel paintGamePanel, SolvedMazeCounter counter, int rowCols) {
        setName(name);
